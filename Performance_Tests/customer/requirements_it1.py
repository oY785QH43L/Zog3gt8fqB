...
def k1() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + "/account/create"
        body = {
...
def login():
    ...
    try:
        url = customer_test_data.it1_prefix + "/account/login"
...
def k2() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + f"/account/update/{str(k2_data["id"])}"
        body = {
...
def k3() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + f"/account/{str(k3_data["id"])}"
...
def k4() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + f"/account/{str(k4_data["id"])}"
...
def k5() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + "/address/create"
        body = {
...
def k8() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + f"/address/{str(k8_data["id"])}"
        start = time.time()
        response = requests.get(url)
        end = time.time()
...
def k10() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + "/product/addtocart"
        body = {
...
def k11() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + "/product/removefromcart"
        body = {
...
def k13() -> float:
    ...
    try:
        ...
        url = customer_test_data.it1_prefix + "/cart/makeorder"
        body = {
