...
def a1() -> float:
    ...
    try:
        ...
        url = admin_test_data.it1_prefix + "/courier/create"
        body = {
...
def a2() -> float:
    ...
    try:
        ...
        url = admin_test_data.it1_prefix + f"/courier/update/{str(a2_data["id"])}"
        body = {
            "adminId": admin_test_data.admin_id,
...
def a4() -> float:
    ...
    try:
        ...
        url = admin_test_data.it1_prefix + "/courier/address/create"
        body = {
            "adminId": admin_test_data.admin_id,
...
def a6() -> float:
    ...
    try:
        ...
        url = admin_test_data.it1_prefix + "/courier/address/remove"
        body = {
            "adminId": admin_test_data.admin_id,
...
def a7() -> float:
    ...
    try:
        ...
        url = admin_test_data.it1_prefix + "/category/create"
...
def a8() -> float:
    ...
    try:
        ...
        url = admin_test_data.it1_prefix + f"/category/update/{str(a8_data["id"])}"
        body = {
            "adminId": admin_test_data.admin_id,
