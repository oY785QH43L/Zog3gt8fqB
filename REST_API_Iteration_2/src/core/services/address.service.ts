...
export class AddressService {
    ...
    public async createNewAddress(address: Address): Promise<Address> {
        ...
        try {
            ...
            this.loggerService.logInfo(`Fetched Address with ID '${address.addressId}'.`, "AddressService-MSSQL");
            ...
            this.loggerService.logInfo(`Fetched Address with data ${JSON.stringify(whereClause)}.`, "AddressService-MSSQL");
            ...
            this.loggerService.logInfo(`Created Address with ID '${address.addressId}'.`, "AddressService-MSSQL");
