...
export class VendorsController implements interfaces.Controller {
     ...
     * @param vendorSessionService The vendors session service.
    ...
    public async addVendorProduct(request: Request, response: Response): Promise<void> {
        try {
            ...
            let productInformation = {
                productId: newId, name: createVendorProductRequestBody.name, description: createVendorProductRequestBody.description,
    ...
    public async updateVendorProduct(request: Request, response: Response): Promise<void> {
        try {
            ...
            let updateInformation = {
                productId: -1, name: updateVendorProductRequestBody.name, description: updateVendorProductRequestBody.description,
